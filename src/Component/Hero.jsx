            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl scale-up-top">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <a
                    href="4"
                    class="rounded-md bg-baseorange px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-custom shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bg-baseorange-200"
                  >
                    Learn more
                  </a>
