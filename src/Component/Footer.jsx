...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/exemplar.space?igsh=MXdtMnVmNW1vbDJ6MQ==",
      icon: (props) => (
...
export default function Footer() {
  return (
    <footer className="bg-bronze " aria-labelledby="footer-heading">
                ...
                <ul role="list" className="mt-6 space-y-4 text-left pl-0">
                  {navigation.links.map((item) => (
                    <li key={item.name}>
                      <Link
                        to={item.href}
                        className="text-sm leading-6 text-white hover:text-black no-underline"
                      >
                        {item.name}
                      </Link>
                    </li>
